...
export default async function Header()
{
    ...
    return <header className="flex justify-between gap-5 p-5 items-center bg-gradient-to-b from-[#041225] to-black sm:bg-none">
        ...
        {/*         <span className=" sm:hidden">
            <Hamburguer />
            <nav className="flex flex-col flex-1 justify-evenly ">
                {linksNames.map(link => 
                {
                    return <NavIndividualLinks goTo={link} key='link' />
                })}
